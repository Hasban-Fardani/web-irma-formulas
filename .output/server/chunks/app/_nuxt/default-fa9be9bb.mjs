...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "flex flex-row justify-center" }, _attrs))}><p class="text-center p-2">Copyright IRMA FORMULAS @ 2023</p></footer>`);
}
  ...
  setup(__props) {
    useHead({
      ...
      meta: [
        ...
        { name: "description", content: "Website informasi tentang IRMA FORMULAS" }
      ],
      link: [
...
//# sourceMappingURL=default-fa9be9bb.mjs.map
